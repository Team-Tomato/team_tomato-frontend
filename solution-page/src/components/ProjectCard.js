...
class ProjectCard extends React.Component{
  render(){
    return(
      <Fade bottom>
      <Card className="mx-auto d-block my-5 card">
          <Card.Img variant="top" src={this.props.image} className="img-fluid image" style={{height: '15rem', width:'18rem'}} alt={this.props.projectName}/>
